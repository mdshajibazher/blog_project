    ...
    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            @endif
                    ...
                    <img width="50%" class="img-thumbnail" src="{{asset('public/image/post/'.$post->image)}}" alt="">
                    </div>
                    <div class="form-group">
                            
                            <input type="checkbox" id="publish" class="filled-in" name="status" value="1" @if($post->status==1 ) checked @endif>
            ...
            <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('categories') ? 'focused error' : ''}}">
                            ...
                            <option @foreach ($post->categories as $category)
                                {{$category->id == $item->id ? 'selected="selected"' : ''}}
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('tags') ? 'focused error' : ''}}">
                            ...
                            {{$tag->id == $item->id ? 'selected="selected"' : ''}}
                        @endforeach
