                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <td style="display:inline-block">
                                    <a class="btn btn-info" href="{{route('author.post.show',$item->id)}}"><i class="material-icons">visibility</i></a>
                                    <a class="btn btn-primary" href="{{route('author.post.edit',$item->id)}}"><i class="material-icons">edit</i></a> 

                                     <button onclick="deletePost({{$item->id}})" class="btn btn-danger" type="submit" value="Delete" ><i class="material-icons">delete</i></button>
                                
                                    <form id="delete-from-{{$item->id}}" style="display: inline" action="{{route('author.post.destroy',$item->id)}}" method="POST"> @csrf @method('DELETE') </form> 
                                </td>
                                </tr>
